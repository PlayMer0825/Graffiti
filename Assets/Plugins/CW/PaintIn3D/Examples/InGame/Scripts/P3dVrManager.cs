...
namespace PaintIn3D {
    ...
    public class P3dVrManager : MonoBehaviour {
        ...
        public float GrabDistance { set { grabDistance = value; } get { return grabDistance; } }
        [SerializeField] private float grabDistance = 0.3f;

        /// <summary>This key allows you to simulate a left hand VR trigger.</summary>
        public KeyCode SimulatedLeftTrigger { set { simulatedLeftTrigger = value; } get { return simulatedLeftTrigger; } }
        [SerializeField] private KeyCode simulatedLeftTrigger = KeyCode.Mouse0;

        /// <summary>This key allows you to simulate a left hand VR grip.</summary>
        public KeyCode SimulatedLeftGrip { set { simulatedLeftGrip = value; } get { return simulatedLeftGrip; } }
        [SerializeField] private KeyCode simulatedLeftGrip = KeyCode.LeftControl;

        /// <summary>This key allows you to simulate a right hand VR trigger.</summary>
        public KeyCode SimulatedRightTrigger { set { simulatedRightTrigger = value; } get { return simulatedRightTrigger; } }
        [SerializeField] private KeyCode simulatedRightTrigger = KeyCode.Mouse1;

        /// <summary>This key allows you to simulate a right hand VR grip.</summary>
        public KeyCode SimulatedRightGrip { set { simulatedRightGrip = value; } get { return simulatedRightGrip; } }
        [SerializeField] private KeyCode simulatedRightGrip = KeyCode.RightControl;

        /// <summary>When simulating a VR tool, it will be offset by this Euler rotation.</summary>
        public Vector3 SimulatedTilt { set { simulatedTilt = value; } get { return simulatedTilt; } }
        [SerializeField] private Vector3 simulatedTilt = new Vector3(0.0f, -15.0f, 0.0f);

        /// <summary>When simulating a VR tool, it will be offset by this local position.</summary>
        public Vector3 SimulatedOffset { set { simulatedOffset = value; } get { return simulatedOffset; } }
        [SerializeField] private Vector3 simulatedOffset = new Vector3(0.0f, 0.0f, -0.2f);

        /// <summary>When simulating a VR tool, it will be moved away from the hit surface by this.</summary>
        public float SimulatedDistanceMax { set { simulatedReach = value; } get { return simulatedReach; } }
        [SerializeField] private float simulatedReach = 1.0f;

        /// <summary>The simulated left VR eye will be offset this much.</summary>
        public Vector3 SimulatedEyeOffset { set { simulatedEyeOffset = value; } get { return simulatedEyeOffset; } }
        [SerializeField] private Vector3 simulatedEyeOffset = new Vector3(-0.0325f, 0.0f, 0.0f);

        /// <summary>When simulating a VR tool, this will control how much the hit surface normal influences the tool rotation.</summary>
        public float SimulatedNormalInfluence { set { simulatedNormalInfluence = value; } get { return simulatedNormalInfluence; } }
        [Range(0.0f, 1.0f)] [SerializeField] private float simulatedNormalInfluence = 0.25f;
        ...
        public static LinkedList<P3dVrManager> Instances { get { return instances; } }
        private static LinkedList<P3dVrManager> instances = new LinkedList<P3dVrManager>(); private LinkedListNode<P3dVrManager> instancesNode;
