...
namespace PaintIn3D {
    ...
    public class P3dInputAxis : MonoBehaviour {
        ...
        public int AxisIndex { set { axisIndex = value; } get { return axisIndex; } }
        [SerializeField] private int axisIndex;

        public BoolEvent OnValue { get { if(onValue == null) onValue = new BoolEvent(); return onValue; } }
        [SerializeField] private BoolEvent onValue;
