...
namespace PaintIn3D {
    ...
    public class P3dSpiral : MonoBehaviour {
        ...
        public Vector3 Rotation { set { rotation = value; } get { return rotation; } }
        [SerializeField] private Vector3 rotation;

        public float Radius { set { radius = value; } get { return radius; } }
        [SerializeField] private float radius = 10.0f;

        public float RadiusAngle { set { radiusAngle = value; } get { return radiusAngle; } }
        [SerializeField] private float radiusAngle;

        public float RadiusSpeed { set { radiusSpeed = value; } get { return radiusSpeed; } }
        [SerializeField] private float radiusSpeed = 5.0f;

        public float Offset { set { offset = value; } get { return offset; } }
        [SerializeField] private float offset = 1.0f;

        public float OffsetAngle { set { offsetAngle = value; } get { return offsetAngle; } }
        [SerializeField] private float offsetAngle;

        public float OffsetSpeed { set { offsetSpeed = value; } get { return offsetSpeed; } }
