...
namespace PaintIn3D {
    ...
    public class P3dGenerateMask : MonoBehaviour {
        ...
        public Mesh Mesh { set { mesh = value; } get { return mesh; } }
        [SerializeField] private Mesh mesh;

        /// <summary>The mask will be generated from this submesh of the mesh.</summary>
        public int Submesh { set { submesh = value; } get { return submesh; } }
        [SerializeField] private int submesh;

        /// <summary>The texture channel of the mesh the mask will be generated from.</summary>
        public P3dCoord Coord { set { coord = value; } get { return coord; } }
        [SerializeField] private P3dCoord coord;

        /// <summary>The size of the generated texture.</summary>
        public Vector2Int Size { set { size = value; } get { return size; } }
        [SerializeField] private Vector2Int size = new Vector2Int(512, 512);

        /// <summary>The format of the generated texture.</summary>
        public RenderTextureFormat Format { set { format = value; } get { return format; } }
        [SerializeField] private RenderTextureFormat format = RenderTextureFormat.R8;
        ...
        public ApplyType ApplyTo { set { applyTo = value; } get { return applyTo; } }
        [SerializeField] private ApplyType applyTo = ApplyType.Siblings;

        /// <summary>After the mask is generated, this event will be invoked.</summary>
        public RenderTextureEvent OnGenerated { get { if(onGenerated == null) onGenerated = new RenderTextureEvent(); return onGenerated; } }
        [SerializeField] private RenderTextureEvent onGenerated;
