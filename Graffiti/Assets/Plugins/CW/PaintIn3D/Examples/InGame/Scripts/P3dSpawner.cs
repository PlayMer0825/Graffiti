...
namespace PaintIn3D {
    ...
    public class P3dSpawner : MonoBehaviour, IHitPoint {
        ...
        public List<GameObject> Prefabs { get { if(prefabs == null) prefabs = new List<GameObject>(); return prefabs; } }
        ...
        public float OffsetNormal { set { offsetNormal = value; } get { return offsetNormal; } }
        [SerializeField] private float offsetNormal;

        /// <summary>The spawned prefab will be offset from the hit point based on this value in world space.</summary>
        public Vector3 OffsetWorld { set { offsetWorld = value; } get { return offsetWorld; } }
        [SerializeField] private Vector3 offsetWorld;
