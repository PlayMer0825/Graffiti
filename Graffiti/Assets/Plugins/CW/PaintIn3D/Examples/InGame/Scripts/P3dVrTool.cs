...
namespace PaintIn3D {
    ...
    public class P3dVrTool : MonoBehaviour {
        ...
        public XRNode Node { set { node = value; } get { return node; } }
        ...
        public Vector3 LocalOffset { set { localOffset = value; } get { return localOffset; } }
        ...
        [SerializeField] private Vector3 simulatedOffset = new Vector3(0.0f, 0.0f, 0.0f);

        /// <summary>The <b>SimulatedOffset</b> value will be offset by this when the simulated key is held.</summary>
        public Vector3 SimulatedKeyOffset { set { simulatedKeyOffset = value; } get { return simulatedKeyOffset; } }
        [SerializeField] private Vector3 simulatedKeyOffset;

        /// <summary>This allows you to control the speed of the simulated transform changes.</summary>
        public float SimulatedDampening { set { simulatedDampening = value; } get { return simulatedDampening; } }
        [SerializeField] private float simulatedDampening = 5.0f;

        public UnityEvent OnGrabbed { get { if(onGrabbed == null) onGrabbed = new UnityEvent(); return onGrabbed; } }
        [SerializeField] private UnityEvent onGrabbed;

        public UnityEvent OnDropped { get { if(onDropped == null) onDropped = new UnityEvent(); return onDropped; } }
        [SerializeField] private UnityEvent onDropped;

        public UnityEvent OnTriggerPress { get { if(onTriggerPress == null) onTriggerPress = new UnityEvent(); return onTriggerPress; } }
        [SerializeField] private UnityEvent onTriggerPress;

        public UnityEvent OnTriggerRelease { get { if(onTriggerRelease == null) onTriggerRelease = new UnityEvent(); return onTriggerRelease; } }
        [SerializeField] private UnityEvent onTriggerRelease;

        public UnityEvent OnGripPress { get { if(onGripPress == null) onGripPress = new UnityEvent(); return onGripPress; } }
        [SerializeField] private UnityEvent onGripPress;

        public UnityEvent OnGripRelease { get { if(onGripRelease == null) onGripRelease = new UnityEvent(); return onGripRelease; } }
        [SerializeField] private UnityEvent onGripRelease;
